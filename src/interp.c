...
const struct cmd_type cmd_table[] = {
    ...
    {CMD_WAIT("leadership", do_leadership, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_NINJA_WAIT("murder", do_murder, POS_FIGHTING, 5, LOG_ALWAYS, C_TYPE_ACTION,
                    C_SHOW_ALWAYS)},
    {CMD_WAIT("palmstrike", do_palmstrike, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_WAIT("dunmar's call", do_warcry, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_WAIT("fist of the interior form", do_fist_of_the_interior_form, POS_FIGHTING, 0,
              LOG_NORMAL, C_TYPE_ACTION, C_SHOW_SKILL)},
    ...
    {CMD_WAIT("overwhelming assault", do_overwhelming_assault, POS_FIGHTING, 0, LOG_NORMAL,
              C_TYPE_ACTION, C_SHOW_SKILL)},
    {CMD_WAIT("oathshield", do_oathshield, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_WAIT("reflex disruption", do_reflex_disruption, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    {CMD_WAIT("holystrike", do_holystrike, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_WAIT("choke hold", do_choke_hold, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    ...
    {CMD_WAIT("roll with blow", do_roll_with_blow, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION,
              C_SHOW_SKILL)},
    {CMD_WAIT("applied understanding", do_pressure_point, POS_FIGHTING, 0, LOG_NORMAL,
              C_TYPE_ACTION, C_SHOW_SKILL)},
    ...
    {CMD("assassinate", do_assassinate, POS_STANDING, 20, LOG_ALWAYS, C_TYPE_ACTION,
         C_SHOW_ALWAYS)},
    ...
    {CMD("home", do_clan_recall, POS_STANDING, CLAN_ONLY, LOG_NORMAL, C_TYPE_ACTION,
         C_SHOW_ALWAYS)},
    ...
    {CMD("resetpasswd", do_resetpassword, POS_DEAD, L_GOD, LOG_ALWAYS, C_TYPE_STAFF,
         C_SHOW_ALWAYS)},
    ...
    {CMD("resetgain", do_gain_stat_reset, POS_DEAD, L_GOD, LOG_ALWAYS, C_TYPE_STAFF,
         C_SHOW_ALWAYS)},
    ...
    {CMD("presence", do_command_presence, POS_FIGHTING, 0, LOG_NORMAL, C_TYPE_ACTION,
         C_SHOW_SKILL)},
    ...
    {CMD("clawspursuit", do_claws_pursuit, POS_STANDING, 0, LOG_NORMAL, C_TYPE_ACTION,
         C_SHOW_SKILL)},
